% This code runs the callback sections of the mask for Cantilever 
% Cartesian robot subsystem used for the Cantilever Cartesian robot 
% configuration of a Cartesian robot.
...
variantName = 'CantileverCartesianRobotVariant';
variantBlockPath = [sys,'/CantileverCartesianRobotVariant'];
...
switch dof.Value
    case "2DOF"
        configAxis.TypeOptions = {'XY','XZ','YZ'};
        switch configAxis.Value
            case 'XY'
                tabXAxis.Visible = 'on';
                tabYAxis.Visible = 'on';
                tabZAxis.Visible = 'off';
                set_param(variantBlockPath, 'LabelModeActiveChoice', 'XYC');
            ...
            case 'XZ'
                tabXAxis.Visible = 'on';
                tabYAxis.Visible = 'off';
                tabZAxis.Visible = 'on';
                set_param(variantBlockPath, 'LabelModeActiveChoice', 'XZC');
            ...
            case 'YZ'
                tabXAxis.Visible = 'off';
                tabYAxis.Visible = 'on';
                tabZAxis.Visible = 'on';
                set_param(variantBlockPath, 'LabelModeActiveChoice', 'YZC');
    ...
    case "3DOF"
        ...
        tabYAxis.Visible = 'on';
        tabZAxis.Visible = 'on';
        set_param(variantBlockPath, 'LabelModeActiveChoice', 'XYZC');
    ...
    case "4DOF"
        ...
        tabYAxis.Visible = 'on';
        tabZAxis.Visible = 'on';
        set_param(variantBlockPath, 'LabelModeActiveChoice', 'XYZRC');
...
% based on the Cantilever Cartesian Robot subsystem mask parameter selection.
